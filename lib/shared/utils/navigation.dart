...
class Navegations {
  ...
  static Future<Ty> persistentTo<Ty extends Object?>(BuildContext context, {required Widget widget, bool? withNavBar}) async => await PersistentNavBarNavigator.pushNewScreen(context,
    screen: widget,
